...
# Маппинг времени дня: склонения и предлоги (утро/день/вечер)
TIME_OF_DAY_MAP = {
    # утро
    'утро': (10, 0), 'утром': (10, 0), 'утра': (10, 0),
    'с утра': (10, 0), 'к утру': (10, 0), 'наутро': (10, 0), 'поутру': (10, 0),
    'по утру': (10, 0), 'на утро': (10, 0),
    # день
    'день': (14, 0), 'днем': (14, 0), 'днём': (14, 0), 'дня': (14, 0),
    'в день': (14, 0), 'к полудню': (14, 0), 'полдень': (14, 0),
    'в обед': (14, 0), 'обед': (14, 0),
    # вечер
    'вечер': (19, 0), 'вечером': (19, 0), 'вечера': (19, 0),
    'к вечеру': (19, 0), 'под вечер': (19, 0), 'на вечер': (19, 0),
    'с вечера': (19, 0), 'по вечерам': (19, 0),
}
