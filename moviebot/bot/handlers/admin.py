...
def unsubscribe_command(message):
    ...
    try:
        ...
        text += "Для пользователя: введите его user_id (положительное число)\n"
        text += "Для группы: введите chat_id группы из платежных данных (положительное число, например <code>301810276</code>) или отрицательное число (например <code>-1001234567890</code>)\n\n"
        text += "Пример: <code>123456789</code> (пользователь) или <code>301810276</code> (группа)"
