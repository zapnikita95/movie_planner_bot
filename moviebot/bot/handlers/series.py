...
<b>📺 Сериалы</b> — раздел, где хранятся ваши сериалы и можно отметить просмотренные серии

<b>📅 Премьеры</b> — в этом разделе вы можете найти премьеру по душе, от даты выхода или от жанра, который вас интересует

<b>🔍 Поиск</b> — поиск фильмов, сериалов и людей через Kinopoisk API

<b>🗄️ База</b> — управление вашей базой фильмов и сериалов: создание подборок, просмотр статистики

<b>🎲 Рандом</b> — выбор случайного непросмотренного фильма с фильтрами (год, жанр, режиссёр)

<b>🔮 Шазам</b> — умный поиск фильмов по описанию того, что вы хотите посмотреть (платный функционал)

<b>🗓️ Расписание</b> — список запланированных просмотров

<b>🎫 Билеты</b> — управление билетами в кино (платный функционал)

<b>💰</b> — информация о подписках и оплате

<b>💻</b> — информация о браузерном расширении

<b>⚙️</b> — настройки бота

<b>❓</b> — эта справка

Подробнее читайте в гайдах: <a href="https://t.me/movie_planner_channel?hashtag=guide">#guide@movie_planner_channel</a>"""
