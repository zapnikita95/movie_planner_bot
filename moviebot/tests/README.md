...
### test_connection_usage.py

Тесты для проверки правильного использования cursor/connection:

- ✅ Проверка использования локальных соединений в функциях
- ✅ Проверка паттернов правильного использования соединений
- ✅ Обнаружение использования глобальных cursor/conn
- ✅ Проверка закрытия соединений в finally блоках

**Всего: 4 теста для проверки использования соединений**
...
- **test_connection_usage.py**: 4 теста
- **Итого: 44+ теста** ✅

## Тесты для проверки cursor/connection

Тесты в `test_connection_usage.py` проверяют:
- ✅ Правильное использование локальных соединений (`conn_local`, `cursor_local`)
- ✅ Закрытие соединений в блоках `finally`
- ✅ Отсутствие использования глобальных `cursor`/`conn` в функциях
- ✅ Соответствие паттернам правильного использования соединений
